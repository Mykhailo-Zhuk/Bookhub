...
export const books: Book[] = [
  {
    ...
    shortDescription:
      "Практичний посібник з написання чистого, читабельного та підтримуваного коду.",
    fullDescription:
    ...
    recommendedWhen:
      "Коли хочете покращити якість коду та навчитися писати чистіше",
  ...
  },
  {
    ...
    coverImage: placeholder,
    shortDescription:
      "Революційний підхід до формування добрих звичок та позбавлення поганих.",
    fullDescription:
    ...
    recommendedFor:
      "Всім, хто хоче змінити свої звички та стати кращою версією себе",
    recommendedWhen:
      "Коли хочете покращити продуктивність або змінити спосіб мислення",
  ...
  },
  {
    ...
    coverImage: placeholder,
    shortDescription:
      "Класика UX-дизайну, яка пояснює психологію людино-машинної взаємодії.",
    fullDescription:
  ...
  },
  {
    ...
    coverImage: placeholder,
    shortDescription:
      "Нобелівський лауреат про дві системи мислення та когнітивні упередження.",
    fullDescription:
  ...
  },
  {
    ...
    coverImage: placeholder,
    shortDescription:
      "Сучасний підхід до проектування архітектури складних програмних систем.",
    fullDescription:
  ...
  },
  {
    ...
    coverImage: placeholder,
    shortDescription:
      "Практичний посібник із запуску бізнесу з мінімальними ресурсами.",
    fullDescription:
    ...
    difficulty: "Початківець",
    recommendedFor:
      "Підприємців-початківців, фрілансерів, власників малого бізнесу",
    recommendedWhen:
      "Коли хочете розпочати власну справу або знайти перших клієнтів",
    externalResources: [{ label: "Amazon", url: "https://amazon.com" }],
    availability: ["Паперова", "Електронна", "Аудіо"],
    status: "Чернетка",
  },
];
