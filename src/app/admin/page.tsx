          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-1">Складність</label>
                  <select
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1">Короткий опис</label>
                <textarea
                  required
                  rows={2}
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1">Повний опис</label>
                <textarea
                  rows={4}
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-sm w-full text-center">
            <p className="text-gray-800 font-medium mb-6">Видалити цю книгу?</p>
            <div className="flex justify-center gap-4">
              <button
                onClick={() => setDeleteConfirm(null)}
                className="px-5 py-2 text-sm border border-gray-200 rounded-xl hover:bg-gray-50"
              >
                Скасувати
              </button>
              <button
