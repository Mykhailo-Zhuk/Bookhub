...
export default function CollectionsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Добірки</h1>
      ...
      {collections.map((col) => {
        ...
        return (
          <section key={col.id} className="mb-14">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-1">{col.title}</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">{col.description}</p>
